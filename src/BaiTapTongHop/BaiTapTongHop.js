...
export default function BaiTapTongHop(props) {
  ...
  return (
    <div>
      <Popup openModal={openModal} setOpenModal={setOpenModal} images={images}></Popup>
      <div className="flex">
        <div className="h-full p-3 space-y-2 bg-coolGray-50 text-coolGray-800">
          ...
          <div className="divide-y divide-coolGray-300">
            <ul className="pt-2 pb-4 space-y-1 text-sm">
              {mangDanhMuc.map((danhMuc, index) => {
                ...
                const classNameActive = ['flex', 'items-center', 'p-2', 'space-x-3', 'rounded-md',maDanhMuc === danhMuc.maDanhMuc ? 'bg-red-400' : ''];
        ...
        <section className="text-gray-600 body-font">
          <h1 className="text-green-400 text-center text-3xl mt-20 ">
            Menu Món Ăn
          </h1>
                    ...
                    <div className="p-4 lg:w-1/3">
                      <div className="h-full bg-gray-100 bg-opacity-75 px-8 pt-16 pb-24 rounded-lg overflow-hidden text-center relative">
                        ...
                        <div className="leading-relaxed mb-3">
                          <img
                            src={itemFilter.hinhAnh}
                            alt={itemFilter.hinhAnh}
                          ></img>{" "}
                        </div>
                        <a className="text-green-500 inline-flex items-center" onClick={()=>{
                          setOpenModal(true);
                          setImages(itemFilter)
                        }}>
                          Chi tiết
                          <svg
