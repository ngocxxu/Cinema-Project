...
export default function Footer(props) {
  ...
  return (
    <footer className="py-6 bg-green-700 text-coolGray-900 text-white">
      <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <div
              ...
              className="flex justify-center space-x-3 md:justify-start cursor-pointer"
            >
        ...
        <div className="grid justify-center pt-6 lg:justify-between">
          <div className=" flex flex-col self-center text-sm text-left md:block lg:col-start-1 md:space-x-6">
            <span>©2021 Project is created by me</span>
              <span>Thank you for your interest</span>
              <span>Hope you have a nice day</span>
          </div>
